...
class CustomerTests(APITestCase):
    ...
    def test_post_and_get_customer(self):
        ...
        response = self.create_customer(
            new_first_name, new_second_name, new_phone_number, new_email, new_personal_id, client)
...
class ReservationTests(APITestCase):
    ...
    def test_post_and_get_reservation(self):
        ...
        new_email = 'jankowalski@gmail.com'
        new_personal_id = '81010200141'
        response_client = self.create_customer(
            new_first_name, new_second_name, new_phone_number, new_email, new_personal_id, client)
        ...
        response_reservation = self.create_reservation(
            1, 1, new_start_date, new_end_date, client)
